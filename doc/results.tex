...
In an attempt to fit the sharp conformal factors at the ears, the resultant mesh fit is again put into the algorithm to be fitted 2 more times and we obtain some mesh actually resembling the target bunny mesh!
